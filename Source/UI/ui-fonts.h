...
#define FONT_ROLES(X) \
	...
	X(list_placeholder, "list/placeholder-font", 18.0f, 700) \
	...
	X(eq_label,			"eq/label-font",			9.0f,	700) \
	...
	X(stil_comment,		"stil-box/comment-font",	13.1f,	500) \
	X(stil_quote,		"stil-box/quote-font",		13.1f,	500) \
	X(stil_bug,			"stil-box/bug-font",		13.1f,	500) \
	X(stil_title,		"stil-box/title-font",		13.1f,	500) \
	X(stil_list,		"stil/list-font",			10.8f,	500) \
	X(stil_mono,		"stil-box/mono-font",		10.7f,	500) \
	X(stil_author,		"stil-box/author-font",		18.4f,	600) \
	...
	X(alert_banner,		"alert-banner/font",		13.1f,	800) \
	X(tag_button,		"tag-button/font",			10.0f,	600) \
	X(stil_toggle,		"stil/toggle-font",			10.0f,	600) \
