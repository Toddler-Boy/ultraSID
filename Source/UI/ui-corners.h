...
#define CORNER_ROLES(X) \
	...
	X(stil_toggle,		"stil/toggle-corner",		1000.0f) \
	...
	X(value_bubble,		"value-bubble/corner",		4.0f) \
	...
	X(stil_portrait,	"stil-box/portrait-corner",	1000.0f) \
	X(stil_link,		"stil-box/link-corner",		4.0f) \
...
namespace UI::corners
{
	...
	// The theme-file path of a role, the reverse of fromName
	[[ nodiscard ]] inline const char* name ( const Role role )
	{
		static constexpr const char* names[] =
		{
			#define X(role, name, r) name,
