...
class GUI_ultraSID_logo final : public juce::Button
{
public:
	GUI_ultraSID_logo ( const juce::String& name, const juce::String& resource );
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR ( GUI_ultraSID_logo )
};
//-----------------------------------------------------------------------------
